---
title: "Daily Truth — 2026-09-22"
date: 2026-09-22
projects: 60
---

# Daily Truth — 2026-09-22
...
|--------|---------------|---------|-------|-----|-----|-------|
| **Helium** | 2026-09-21 `96ae697` fix: cargo-deb asset path relative to package dir | main | 0 (0 funcs) | 0 | 6 |  |
| **LifeTrack** | 2026-09-14 `a45b80c` fix(ci): compliance R76 + eslint no-undef (minimal | master | 0 (0 funcs) | 0 | 7 |  |
| **NeuralDBG** | 2026-09-14 `caa6c7f` fix(ci): newline final manifest (end-of-file-fixer | main | 48 (60 funcs) | 0 | 8 |  |
...
| **Metatron** | 2026-08-23 `69be135` fix(ci): scan SonarQube non bloquant - secret SONA | main | 0 (0 funcs) | 0 | 1 |  |
...
- **Helium** `96ae697` 2026-09-21: _fix: cargo-deb asset path relative to package dir_ — 53% Actif (6 commits 30j)
