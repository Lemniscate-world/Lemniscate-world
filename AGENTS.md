...
| R72   | All UI follows Impeccable design system (github.com/pbakaus/impeccable) + Quiet Precision tokens (DESIGN.md, R108). GATE: `npx -y impeccable detect <files>` = 0 issue obligatoire avant tout push UI. Jamais désactiver. |
---
